...
import com.internalpositioning.find3.find3app.Pools.SimplePool;
 ...
 */
public class MapTouchView extends View {

    // Hold data for active touch pointer IDs
    // ** modify private to public
    public SparseArray<TouchHistory> mTouches;
    ...
    public MapTouchView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                lx = String.valueOf(data.x);
                ly = String.valueOf(data.y);
    ...
    protected void drawCircle(Canvas canvas, int id, TouchHistory data) {
        ...
        String coordinates = data.x + ", " + data.y;

        lx = String.valueOf(data.x);
        ly = String.valueOf(data.y);

        // draw its label next to the main circle
        canvas.drawText(coordinates, data.x + radius, data.y
                - radius, mTextPaint);
    }
